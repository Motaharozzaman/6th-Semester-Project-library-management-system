  ...
  document.body.style.backgroundColor = "white";
	...
	<!----------------search bar------------->
		...
		<form class="navbar-from" method="post" name="from1">
				...
				<input class="from-control" type="text" name="search" placeholder="search books..." required="">
				<button style="background-color:#1976D2 ;" type="submit" name="submit" class="btn btn-default">
					<span class="glyphicon glyphicon-search"></span>
				</button>
			</form><br>	
				<form class="navbar-from" method="post" name="from1">
					<input class="from-control" type="text" name="bid" placeholder=" Enter Book ID" required="">
					<button style="background-color:#1976D2;" type="submit" name="submit1"> Request</button>
				</form>
	...
	<?php
			...
			if (isset($_POST['submit'])) {
				...
				echo "<th>"; echo "DepartmentS"; echo "</th>";
				echo "</tr>";
